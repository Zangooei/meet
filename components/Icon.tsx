...
export const Icon: React.FC<IconProps> = ({ name, className = "", size = 24 }) => {
  const icons: Record<string, React.ReactNode> = {
    ...
    'microphone-slash': <path strokeLinecap="round" strokeLinejoin="round" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" />, // Approximate slash
